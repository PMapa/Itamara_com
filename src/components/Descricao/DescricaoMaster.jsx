      ...
      <>
        <section className="descricaoArea">
          <div>
            ...
            <p>
              Espaço de 86m2, Cama queen size, TV 42” por assinatura com canais
              privados, frigobar completos, ar condicionado quente/frio, wi-fi,
              sistema de automação inteligente (que controla todos os
              equipamentos e iluminação do quarto) e decoração clean.
            </p>
            <br></br>
          </div>
          <div>
        ...
        <div className="observacoes">
          <p>
            *Check-in Pernoite: 2ª a 5ª feira (exceto feriados, vésperas e Dia
            dos Namorados): 20h
            <br />
          ...
          <br />
          <p>
            Feriados específicos, Dia dos Namorados e períodos de alta procura
            poderão sofrer reajuste nas tarifas.
            <br />
